...
// pluginInstallCmd represents the plugin command
var pluginInstallCmd = &cobra.Command{
	Use:   "install",
	Short: "Install and add a new plugin to the Project Flogo CLI",
	Run:   runPluginInstall,
}

// Flags
var (
	installPluginRepoURL string
)
...
func init() {
	...
	pluginInstallCmd.Flags().StringVarP(&installPluginRepoURL, "repo", "r", "", "The repository you want to install the plugin from (required)")
	pluginInstallCmd.MarkFlagRequired("repo")
}

// runPluginInstall is the actual execution of the command
